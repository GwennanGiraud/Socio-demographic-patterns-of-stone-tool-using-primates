...
def generate(N, m, minority_fraction, similitude):
    ...
    # dist2 = defaultdict(int)  # distance between nodes

    H = np.array([[1 - similitude, similitude],
    ...
    #         if n1_attr == n2_attr:
    #             dist2[(n1, n2)] = 1 - similitude  # higher similarity, lower distance
    #         else:
    #             dist2[(n1, n2)] = similitude
